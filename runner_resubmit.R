...
pdf('plots/Fig2C_Prelate_mean.pdf', width = 2.6, height = 4)
...
pdf('plots/Fig2D_NoGo_mean.pdf', width = 2.6, height = 4)
...
pdf('plots/Fig2E_WM_mean.pdf', width = 2.6, height = 4)
...
pdf('plots/Sig2F_STROOP_mean.pdf', width = 2.6, height = 4)
...
pdf('plots/Fig3A_Followed_main.pdf', width = 4, height = 4)
...
pdf('plots/Fig3B_Switch_aligned.pdf', width = 3.5, height = 4)
...
pdf('plots/Fig3C_Followed_mean.pdf', width = 2.6, height = 4)
...
pdf('plots/Fig3D_Followed_proportions.pdf', width = 2.6, height = 4.2)
...
pdf('plots/Fig3E_Recognition_proportions.pdf', width = 2.6, height = 4.2)
...
pdf('plots/Fig3F_Report_proportions.pdf', width = 2.6, height = 4.2)
...
pdf('plots/Fig_4A_Errors_main_Exp2.pdf', width = 4, height = 4)
...
pdf('plots/Fig4C_Prelate_mean_Exp2.pdf', width = 2.6, height = 4)
...
pdf('plots/Fig4D_NoGo_mean_Exp2.pdf', width = 2.6, height = 4)
...
pdf('plots/Fig4E_WM_mean_Exp2.pdf', width = 2.6, height = 4)
...
pdf('plots/Fig4F_STROOP_mean_Exp2.pdf', width = 2.6, height = 4)
...
pdf('plots/Fig5A_Followed_main_Exp2.pdf', width = 4, height = 4)
...
pdf('plots/Fig5B_Switch_aligned_Exp2.pdf', width = 3.5, height = 4)
...
pdf('plots/Fig5C_Followed_mean_Exp2.pdf', width = 2.6, height = 4)
...
pdf('plots/Fig5D_Followed_proportions_Exp2.pdf', width = 2.6, height = 4.2)
...
pdf('plots/Fig5E_Recognition_proportions_Exp2.pdf', width = 2.6, height = 4.2)
...
pdf('plots/Fig5F_Report_proportions_Exp2.pdf', width = 2.6, height = 4.2)
...
clme = lmer(E ~ GROUP + (1|ID), data = subset(regular.cdf, regular.cdf$COND == 'LEARN' & regular.cdf$BLOCK > 6), control = lcctrl, REML = FALSE)
Anova(clme)
emmeans(clme, list(pairwise ~ GROUP), adjust = "tukey")

clme = lmer(RT ~ GROUP + (1|ID), data = subset(regular.cdf, regular.cdf$COND == 'LEARN' & regular.cdf$BLOCK > 6), control = lcctrl, REML = FALSE)
Anova(clme)
emmeans(clme, list(pairwise ~ GROUP), adjust = "tukey")

clme = lmer(PREKEY_late ~ GROUP + (1|ID), data = subset(conflicts.cdf, conflicts.cdf$COND == 'LEARN' & conflicts.cdf$BLOCK > 6), control = lcctrl, REML = FALSE)
Anova(clme)
emmeans(clme, list(pairwise ~ GROUP), adjust = "tukey")

clme = lmer(PREKEY_NoGo ~ GROUP + (1|ID), data = subset(conflicts.cdf, conflicts.cdf$COND == 'LEARN' & conflicts.cdf$BLOCK > 6), control = lcctrl, REML = FALSE)
Anova(clme)
emmeans(clme, list(pairwise ~ GROUP), adjust = "tukey")
...
summary(scores.cdf[,c(18:23, 26:29)])

ctab = aggregate(scores.cdf[,c(18:23, 26:29)], list(scores.cdf$GROUPbin), mean, na.rm = TRUE)
ctab_ses = aggregate(scores.cdf[,c(18:23, 26:29)], list(scores.cdf$GROUPbin), std.error)

dim(ctab)

pdf('plots/Fig6A_Overview.pdf', width = 4, height = 4)
par(mar=c(5.1,7.7,4.1,0.5))

plot(unlist(ctab[,2:11]), as.vector(matrix(c((1:10)-0.1, (1:10)+0.1), 2, 10, byrow = TRUE)),
	type = 'p', col = c(brewer.pal(6, 'Reds')[4], brewer.pal(6, 'Blues')[4]),
	lwd = 2, xlim = c(-0.8, 0.8), ylim = c(0.5, 10.5), ylab = '', xlab = '',
	bty = 'n', cex.axis = 1.1, cex.lab = 1.2,
	xaxt = 'n', yaxt = 'n', pch = 16)
abline(v = 0, lty = 2)
se_bars(unlist(ctab[,c(2:11)]), as.vector(matrix(c((1:10)-0.1, (1:10)+0.1), 2, 10, byrow = TRUE)), unlist(ctab_ses[,c(2:11)]),
	c(brewer.pal(6, 'Reds')[4], brewer.pal(6, 'Blues')[4]), horiz = TRUE)

axis(1, at = seq(-0.8, 0.8, by = 0.4), labels = seq(-0.8, 0.8, by = 0.4), cex = 1.1)
mtext(1, text = 'z Score ', line = 2.7, cex = 1.3)

text(-0.85, 1, 'Working memory', cex = 0.9, xpd = TRUE, pos = 2)
text(-0.85, 2, 'Stroop costs', cex = 0.9, xpd = TRUE, pos = 2)

text(-0.85, 3, 'Errors', cex = 0.9, xpd = TRUE, pos = 2)
text(-0.85, 4, 'RTs', cex = 0.9, xpd = TRUE, pos = 2)
text(-0.85, 5, 'False alarms [delay]', cex = 0.9, xpd = TRUE, pos = 2)
text(-0.85, 6, 'False alarms [noGo]', cex = 0.9, xpd = TRUE, pos = 2)
text(-0.85, 7, 'Color use', cex = 0.9, xpd = TRUE, pos = 2)
text(-0.85, 8, '% Switched', cex = 0.9, xpd = TRUE, pos = 2)
text(-0.85, 9, '% Rule report', cex = 0.9, xpd = TRUE, pos = 2)
text(-0.85, 10, '% Usage report', cex = 0.9, xpd = TRUE, pos = 2)
...
fullmod <- lm(FOLL_logit ~ GROUPbin*(STROOPz+WMz+TASKz+PREz), data=scores.cdf.no.na) #AMBIG can also be included
summary(fullmod)
AIC(fullmod)
...
pdf('plots/Fig6B_Predict.pdf', width = 7, height = 4)
layout(matrix(1:2, 1, 2))

par(mar=c(4,4,1,1))

X = predict(reducedmod)
...
plot(X, Y,type = 'p', col = ccols,
	...
	bty = 'n', cex.axis = 1.1, cex.lab = 1.2,
	xaxt = 'n', yaxt = 'n', pch = 16)
abline(lm_ya, lwd = 2, lty = 1, col = brewer.pal(6, 'Blues')[6])
abline(lm_kids, lwd = 2, lty = 2, col = brewer.pal(6, 'Reds')[6])

axis(1, at = seq(-1, 5, length.out = 5), cex = 1.1)
mtext(1, text = 'Predicted Color Use ', line = 2.7, cex = 1.3)

axis(2, at = seq(-1, 5, length.out = 5), cex = 1.1)
mtext(2, text = 'Color Use (logit)', line = 2.7, cex = 1.3)
...
plot(scores.cdf.no.na$STROOPz[scores.cdf.no.na$GROUPbin == 'YA'], scores.cdf.no.na$FOLL_logit[scores.cdf.no.na$GROUPbin == 'YA']*1,
	type = 'p', col = brewer.pal(6, 'Blues')[6],
...
points(scores.cdf.no.na$STROOPz[scores.cdf.no.na$GROUPbin == 'KIDS'], scores.cdf.no.na$FOLL_logit[scores.cdf.no.na$GROUPbin == 'KIDS']*1,
		type = 'p', col = brewer.pal(6, 'Reds')[6],
		lwd = 2, pch = 16)
abline(lm_ya, lwd = 2, col = brewer.pal(6, 'Blues')[6])
abline(lm_kids, lwd = 2, col = brewer.pal(6, 'Reds')[6])

axis(1, at = seq(round(range(scores.cdf.no.na$STROOPz)[1], 1), round(range(scores.cdf.no.na$STROOPz)[2], 1), length.out = 5), cex = 1.1)
mtext(1, text = 'Stroop Effect (z) ', line = 2.7, cex = 1.3)
...
cor.test(scores.cdf.no.na$FOLL_logit[scores.cdf.no.na$GROUPbin == 'YA']*1, scores.cdf.no.na$STROOPz[scores.cdf.no.na$GROUPbin == 'YA'])
cor.test(scores.cdf.no.na$FOLL_logit[scores.cdf.no.na$GROUPbin == 'KIDS']*1, scores.cdf.no.na$STROOPz[scores.cdf.no.na$GROUPbin == 'KIDS'])
