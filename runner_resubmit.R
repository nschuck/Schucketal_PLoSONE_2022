...
nkids
nadults
pwr.chisq.test(w = 0.3, N = nkids + nadults, df = 1, sig.level = .10)
pwr.chisq.test(w = 0.2, N = nkids + nadults, df = 1, sig.level = .10)
pwr.chisq.test(w = 0.1, N = nkids + nadults, df = 1, sig.level = .10)
...
pdf('plots/Fig6_Overview.pdf', width = 4, height = 4)
